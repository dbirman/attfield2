...
#SBATCH --gres=gpu:1
#SBATCH --output=/scratch/users/kaifox/attfield/data/runs/270420/0917c_%a.out
#SBATCH --error=/scratch/users/kaifox/attfield/data/runs/270420/0917c_%a.err
ml python/3.6.1
...
echo ">> Starting:" $(date +"%T") " : J=$J : BETA=$BETA" \
     > $DATA/runs/270420/0917c_$J.py_out
$py3 $CODE/script/backprop.py \
    ...
    >> $DATA/runs/270420/0917c_$J.py_out \
    2> $DATA/runs/270420/0917c_$J.py_err
