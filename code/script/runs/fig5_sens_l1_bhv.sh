...
#SBATCH --output=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sl1bhv_%a.out
#SBATCH --error=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sl1bhv_%a.err
...
LOG="$DATA/runs/fig5/logs/sl1bhv_b$BETA"
...
$py3 $CODE/script/reg_task.py \
    $DATA/runs/fig5/bhv_sens_l1_n${N_IMG_PER_CAT}_b$BETA.h5  `# Output Path` \
