...
#SBATCH --output=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sn4bhv_%a.out
#SBATCH --error=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sn4bhv_%a.err
...
LOG="$DATA/runs/fig5/logs/sn4bhv_b$BETA"
...
$py3 $CODE/script/reg_task.py \
    $DATA/runs/fig5/sn4_bhv_n${N_IMG_PER_CAT}_b$BETA.h5  `# Output Path` \
