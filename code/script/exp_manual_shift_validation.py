...
UNIT_LAYERS = [(0,),]
BETAS = [1.1, 2.0, 4.0, 11.0, 50., -11.]
# Attention settings to test
ATTS = {
    'ms': lambda b: {
        (0, 0): atts.GaussianManualShiftAttention((56, 56), (56, 56), b)},
}
...
# Path parameters
DATA_OUT = Paths.data("exp/manual_shift_val/")
PLOT_OUT = Paths.plots("exp/manual_shift_val/")
