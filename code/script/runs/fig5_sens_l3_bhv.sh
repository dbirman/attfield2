...
#SBATCH --output=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sl3bhv_%a.out
#SBATCH --error=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sl3bhv_%a.err
...
BETA=${BETA[$J]}
N_IMG_PER_CAT=600  # 4 min for 100
LOG="$DATA/runs/fig5/logs/sl3bhv_b$BETA"
...
$py3 $CODE/script/reg_task.py \
    $DATA/runs/fig5/bhv_sens_l3_n${N_IMG_PER_CAT}_b$BETA.h5  `# Output Path` \
    ...
    --attn_cfg "layer=(0,3,0):beta=$ADJ:neg_mode='fix'"        \
