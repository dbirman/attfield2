...
ATTS = {
    'ms-0': lambda b: {
        (0, 0, 0): atts.GaussianSensitivityGradAttention((56, 56), (56, 56), b)},
}
...
BATCH_SIZE = 5                  # Batch size for model runs

# Path parameters
DATA_OUT = Paths.data("exp/att_models/sens")
PLOT_OUT = Paths.plots("exp/att_models/sens")
