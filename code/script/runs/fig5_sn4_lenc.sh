...
#SBATCH --output=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sn4_lenc_%a.out
#SBATCH --error=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sn4_lenc_%a.err
...
LOG="$DATA/runs/fig5/logs/sn4_lenc_b$BETA"
...
py3 $CODE/script/encodings.py \
    $DATA/runs/fig5/lenc_sn4_n${N_IMG_PER_CAT}_b$BETA.h5   `# Output Path` \
