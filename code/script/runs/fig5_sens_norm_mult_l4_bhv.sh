...
#SBATCH --output=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sm4bhv_%a.out
#SBATCH --error=/scratch/users/kaifox/attfield/data/runs/fig5/logs/sm4bhv_%a.err
...
LOG="$DATA/runs/fig5/logs/sm4bhv_b$BETA"
...
$py3 $CODE/script/reg_task.py \
    $DATA/runs/fig5/bhv_sens_norm_mult_l4_n${N_IMG_PER_CAT}_b$BETA.h5  `# Output Path` \
